...
const sql = `CREATE OR REPLACE FUNCTION public.sync_user_to_registered()
RETURNS TRIGGER AS $$
BEGIN
...
async function run() {
  const res = await fetch('https://api.supabase.com/v1/projects/abdwszaejrzqtjlvhakw/database/query', {
    method: 'POST',
